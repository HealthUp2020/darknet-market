...
- **Cały interfejs przetłumaczony na angielski** (nazwy towarów, log, przyciski, nagłówki). Nazwy: AI Cores, Implants, Corp Data, Pharma, Cracked SW, Weaponry, Drones; rynek → Night Market; stado → fleet; Pieczęć Doskonałości → Fixer Reputation; log → System Terminal. Tytuł: `NETRUNNER://BLACK_MARKET`.
