# Animation — card deal-in (market fills), Everdell-style
...
light settles. Build a small deck stack + a row of 7 angled NIGHT MARKET cards; a REPLAY button
re-deals. Cards use the existing GameCard look (angled frame, name + pips, icon well, tier + value).
```
